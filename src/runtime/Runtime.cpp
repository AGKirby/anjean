...
namespace Anjean::Runtime {
  ...
  void Runtime::setGameObjectPhysicsBody(std::uint32_t gameObjectId, std::uint32_t physicsBodyId) {
  ...
  std::uint32_t Runtime::getGameObjectPhysicsBody(std::uint32_t gameObjectId) {
    GameObject& object = getGameObjectById(gameObjectId);
